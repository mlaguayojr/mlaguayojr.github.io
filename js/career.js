  ...
  career: [
    {
      ...
      superscript: "1",
      footnote:
        "Solovis was wholly owned by Nasdaq until September of 2025, at which point it was sold to Insight Partners, a private equity firm specializing in software.",
      location: "Remote",
      ...
      content: [
        {
          topic:
            "Engineered Core Data Platform, a self-service ETL application empowering users to extract datasets from the Solovis ecosystem.",
          subtopic: [
        ...
        {
          topic:
            "Maintained Fund Automated Sync Tool, a legacy Windows Forms application to maintain fund data within the Solovis ecosystem.",
          subtopic: [
        ...
        {
          topic:
            "Maintained Integration Hub, a data pipeline ETL system for custodial data integrations.",
          subtopic: [
        ...
        {
          topic:
            "Engineered Benchmark Blender, a scalable, rule-based system to manage custom benchmarks in Portfolio Analytics.",
          subtopic: [
    ...
    },
    {
      ...
      content: [
        {
          topic:
            "Implemented Linux-based infrastructure for Splunk, a logging and SIEM system to lower operational costs and improve monitoring.",
          subtopic: [
        ...
        {
          topic:
            "Implemented Tenable.SC, a vulnerability management platform to secure and monitor our company network.",
          subtopic: [
        ...
        {
          topic:
            "Performed enterprise system administration, security analysis, and group management.",
          subtopic: [
    ...
    },
    {
      ...
      content: [
        {
          topic:
            "Maintained and implemented requested features within home-grown legacy applications.",
          subtopic: [
        ...
        {
          topic:
            "Created reports across various production departments delivered by SSRS and e-mail.",
          subtopic: [
        ...
        {
          topic:
            "Developed automation to expedite Mail Production workflow supporting other systems.",
          subtopic: [
    ...
    },
    {
      ...
      content: [
        {
          topic:
            "Converted existing WebFocus, Python, and MSSQL reports for use in frontend dashboards using the Yii PHP framework.",
        },
        {
          topic:
            "Utilized Three.js to render and interact with 3D CAD files directly within a web page.",
        },
        {
          topic:
            "Built a wrapper solution to integrate an internal CRM with a third-party vendor's software using PHP.",
        },
      ],
    },
    {
      ...
      content: [
        {
          topic:
            "Created applications to replace manual, time-consuming processes across driver and invoicing workflows.",
          subtopic: [
        ...
        {
          topic:
            "Utilized Google's Distance Matrix API to visualize area of coverage for branch locations.",
        },
        {
    ...
    },
    {
      ...
      content: [
        {
          topic:
            "Exposure to industry recognized access management and security solutions.",
          subtopic: [
      ...
      const data = {
        career: careerData.career.map((job) => ({
          ...
          content: job.content.map((item) => ({
            ...item,
            hasSubtopic:
              Array.isArray(item.subtopic) && item.subtopic.length > 0,
          })),
        })),
      };
      document.getElementById("career").innerHTML = Mustache.render(
        template,
        data,
      );
    });
